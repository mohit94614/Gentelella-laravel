...
@section('extra-css')
    ...
    <link href="{{URL::asset('theme/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}" rel="stylesheet">
    <!-- Ion.RangeSlider -->
    <link href="{{URL::asset('theme/vendors/normalize-css/normalize.css')}}" rel="stylesheet">
    <link href="{{URL::asset('theme/vendors/ion.rangeSlider/css/ion.rangeSlider.css')}}" rel="stylesheet">
    <link href="{{URL::asset('theme/vendors/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css')}}" rel="stylesheet">
    <!-- Bootstrap Colorpicker -->
    <link href="{{URL::asset('theme/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}" rel="stylesheet">

    <link href="{{URL::asset('theme/vendors/cropper/dist/cropper.min.css')}}" rel="stylesheet">
...
@section('extra-scripts')
    ...
    <!-- bootstrap-datetimepicker -->
    <script src="{{URL::asset('theme/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}"></script>
    <!-- Ion.RangeSlider -->
    <script src="{{URL::asset('theme/vendors/ion.rangeSlider/js/ion.rangeSlider.min.js')}}"></script>
    <!-- Bootstrap Colorpicker -->
    <script src="{{URL::asset('theme/vendors/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')}}"></script>
    <!-- jquery.inputmask -->
    <script src="{{URL::asset('theme/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js')}}"></script>
    <!-- jQuery Knob -->
    <script src="{{URL::asset('theme/vendors/jquery-knob/dist/jquery.knob.min.js')}}"></script>
    <!-- Cropper -->
    <script src="{{URL::asset('theme/vendors/cropper/dist/cropper.min.js')}}"></script>
