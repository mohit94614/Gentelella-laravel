...
@section('extra-scripts')
    ...
    <!-- morris.js -->
    <script src="{{ URL::asset('theme/vendors/raphael/raphael.min.js')}}"></script>
    <script src="{{ URL::asset('theme/vendors/morris.js/morris.min.js')}}"></script>
    <!-- gauge.js -->
    ...
    <!-- jQuery Sparklines -->
    <script src="{{ URL::asset('theme/vendors/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
    <!-- Flot -->
