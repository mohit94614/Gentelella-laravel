                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="product-image">
                                    <img src="{{URL::asset('images/prod-1.jpg')}}" alt="..." />
                                </div>
                                <div class="product_gallery">
                                    <a>
                                        <img src="{{URL::asset('images/prod-2.jpg')}}" alt="..." />
                                    </a>
                                    <a>
                                        <img src="{{URL::asset('images/prod-3.jpg')}}" alt="..." />
                                    </a>
                                    <a>
                                        <img src="{{URL::asset('images/prod-4.jpg')}}" alt="..." />
                                    </a>
                                    <a>
                                        <img src="{{URL::asset('images/prod-5.jpg')}}" alt="..." />
                                    </a>
                                </div>
                            </div>
