...
@section('extra-scripts')
    ...
    <script src="{{URL::asset('theme/vendors/jqvmap/dist/maps/jquery.vmap.usa.js')}}"></script>
    <script src="{{URL::asset('theme/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js')}}"></script>
    <!-- easy-pie-chart -->
    <script src="{{URL::asset('theme/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js')}}"></script>
